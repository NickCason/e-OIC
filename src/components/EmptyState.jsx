...
import { CyclingDotmSquare } from './dotmatrix/CyclingDotmSquare.tsx';
...
export default function EmptyState({ icon = 'imageOff', title, body, pointTo = null, action }) {
  return (
    <div className="empty-state" role="status">
      <div className="empty-state-matrix" aria-hidden="true">
        <CyclingDotmSquare size={72} intervalMs={5000} />
      </div>
