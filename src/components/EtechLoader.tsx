...
export type EtechLoaderVariant = 'current' | 'color' | 'white' | 'black';

export interface IEtechLoaderProps {
    variant?: EtechLoaderVariant;
    size?: number | string;
    ariaLabel?: string;
}

const EtechLoader = ({ variant = 'current', size = 24, ariaLabel = 'Loading' }: IEtechLoaderProps) => (
    <svg
